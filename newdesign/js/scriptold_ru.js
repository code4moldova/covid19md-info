(function ($) {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Ежедневно подтвержденные случаи",
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Подтвержденные случаи по возрастам",
              data: infectatiAni,
              borderColor: "red",
              borderWidth: "0",
              backgroundColor: "red",
  ...
  try {
    ...
    if (ctx) {
      ...
      var labels = {y_infectate:'Подтвержденные случаи',y_suspecte:"Подозрения",y_vindecati:"Вылечившиеся",y_decedati:'Погибшие'}
      ctx.height = 200;
      var myChart = new Chart(ctx, {
        type: 'bar',
        defaultFontFamily: 'Poppins',
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            label: "Под домашним наблюдением",
...
plotsmall("sales-chart2", "Подтвержденные случаи", 'y_infectate')
plotsmall("sales-chart3", "Подозрения", 'y_suspecte')
plotsmall("sales-chart4", "Вылечившиеся", 'y_vindecati')
plotsmall("sales-chart5", "Погибшие", 'y_decedati')
